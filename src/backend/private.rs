...
unsafe extern "C" {
    ...
    pub fn CGSMoveWindowsToManagedSpace(connection: CGSConnectionID, window_ids: *const CFArray, target_space_id: CGSSpaceID);
...
mod tests {
    ...
    fn list_all_workspaces() {
        ...
        unsafe {
            ...
            let space_ids: CFRetained<CFArray> = CFRetained::from_raw(NonNull::new(space_ids_raw.cast_mut()).unwrap());
